                ...
                <div class="row mb-3">
                    ...
                    <%
                        if (errores != null && errores.containsKey("username")) {
                            out.println("<smal class='alert alert-danger col-sm-4'>" + errores.get("username") + "</smal>");
                        }
                    %>
                </div>
                <div class="row mb-3">
                    ...
                    <%
                        if (errores != null && errores.containsKey("password")) {
                            out.println("<smal class='alert alert-danger col-sm-4'>" + errores.get("password") + "</smal>");
                        }
                    %>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <input type="tex" name="email" id="email" class="form-control" value="${param.email}">
                    </div>
                    <%
                        if (errores != null && errores.containsKey("email")) {
                            out.println("<smal class='alert alert-danger col-sm-4'>" + errores.get("email") + "</smal>");
                        }
                    %>
                </div>
                <div class="row mb-3">
                    ...
                    <%
                        if (errores != null && errores.containsKey("pais")) {
                            out.println("<smal class='alert alert-danger col-sm-4'>" + errores.get("pais") + "</smal>");
                        }
                    %>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <%
                        if (errores != null && errores.containsKey("roles")) {
                            out.println("<smal class='alert alert-danger col-sm-4'>" + errores.get("roles") + "</smal>");
                        }
                    %>
                </div>
                <div class="row mb-3">
                    ...
                    <%
                        if (errores != null && errores.containsKey("idioma")) {
                            out.println("<smal class='alert alert-danger col-sm-4'>" + errores.get("idioma") + "</smal>");
                        }
                    %>
                </div>
                <div class="row mb-3">
